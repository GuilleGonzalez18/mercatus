...
// Setup and create cfeBuilder.js with full path creation
try {
...
`;
  ...
  fs.writeFileSync(dirPath + '\\cfeBuilder.js', content);
  console.log('✓ Successfully created D:\\repos\\ferco-posta\\backend\\src\\services\\cfeBuilder.js');
  console.log('✓ File size: ' + fs.statSync(dirPath + '\\cfeBuilder.js').size + ' bytes');
} catch (err) {
